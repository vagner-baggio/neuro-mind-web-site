      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a 
                href="https://instagram.com/drjacksoncosta" 
                target="_blank" 
              ...
              <a 
                href="https://linkedin.com/in/drjacksoncosta" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-slate-700 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all duration-300"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 text-center">
          ...
          <p className="text-blue-300 text-lg font-medium italic">
            "Um olhar acolhedor para responder seus porquês."
          </p>
        </div>
      </div>
    </footer>
